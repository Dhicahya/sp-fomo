            ...
            <ul>
                @auth
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle py-0 d-flex align-items-center" href="#" id="userDropdown"
                            ...
                            @else
                                <img class="img-profile rounded-circle ms-2" src="/img/undraw_profile.svg"
                                    style="height: 35px">
                            @endif
                        </a>
